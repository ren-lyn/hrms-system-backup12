...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            // For MySQL/other databases - Add "Offer Accepted" and "Offer Sent" to the enum
    ...
    public function down(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            // For MySQL/other databases - Revert to previous enum
            DB::statement("ALTER TABLE applications MODIFY status ENUM('Applied', 'Pending', 'ShortListed', 'Interview', 'On going Interview', 'Offered', 'Offered Accepted', 'Onboarding', 'Hired', 'Rejected') DEFAULT 'Applied'");
        }
    }
};
