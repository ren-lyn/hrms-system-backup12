...
class LeaveRequestSubmittedToHR extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('A new leave request has been submitted by an employee and requires your review.')
    ...
    {
        return [
            'type' => 'leave_request_submitted_hr',
