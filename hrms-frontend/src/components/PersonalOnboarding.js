                      ...
                      <Card.Body className="p-4">
                        ...
                        <div className="row g-3">
                          ...
                          {section.documents.map((document) => {
                            ...
                            const isLockedByBackend = typeof documentData?.lock_uploads === 'boolean' ? documentData.lock_uploads : null;

                            const isLockedByRemote = isLockedByBackend !== null

                              ? isLockedByBackend

                              : (hasRemoteFile && statusKey !== 'resubmission_required');

                            const canUploadFromBackend = typeof documentData?.can_upload === 'boolean' ? documentData.can_upload : null;

                            const canUploadDocument = canUploadFromBackend !== null
                            ...
                            const selectButtonClass = `btn btn-outline-primary btn-sm d-inline-flex align-items-center${(isUploadingThisDocument || isLockedByRemote || !canUploadDocument) ? ' disabled opacity-75' : ''}`;

                            const selectButtonStyle = (isUploadingThisDocument || isLockedByRemote || !canUploadDocument) ? { pointerEvents: 'none' } : undefined;
                                ...
                                <div className="p-3 border rounded-3 bg-light bg-opacity-50 document-upload-field">
                                  ...
                                  <div className="d-flex flex-column flex-lg-row gap-3">
                                    ...
                                    <div className="flex-grow-1">
                                      ...
                                      {isLockedByRemote && documentData?.upload_lock_reason && (
                                      ...
                                      <div className="d-flex flex-column flex-sm-row align-items-start align-items-sm-center gap-3 mt-3">
                                        ...
                                        <div>
                                          ...
                                          <Form.Control
                                            ...
                                            disabled={isUploadingThisDocument || isLockedByRemote || !canUploadDocument}
