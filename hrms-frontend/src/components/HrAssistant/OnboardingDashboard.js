...
const extractGovernmentIdsFromDocuments = (documents, fieldMap) => {
  const result = {
    sss: "",
    philhealth: "",
    pagibig: "",
  ...
  documents.forEach((doc) => {
    ...
    if (
      !documentKey ||
      !Object.prototype.hasOwnProperty.call(GOVERNMENT_ID_TO_FORM_FIELD_MAP, documentKey)
    ) {
      return;
    }

    const formField = GOVERNMENT_ID_TO_FORM_FIELD_MAP[documentKey];
    const config = fieldMap[documentKey];
...
const extractProfilePhotoFromDocuments = (documents) => {
  if (!Array.isArray(documents)) {
    return "";
  }
...
const closeDocumentModal = useCallback(() => {
    ...
    (entry) => {
      ...
      const loadGovernmentIds = async () => {
        try {
          ...
          const documents = Array.isArray(overviewData?.documents)
          ...
          const governmentIds = extractGovernmentIdsFromDocuments(
            documents,
            GOVERNMENT_ID_FIELD_MAP
          );
          const profilePhotoUrl = normalizeAssetUrl(
            extractProfilePhotoFromDocuments(documents)
          );
          setProfileCreationForm((prev) => ({
            ...prev,
  ...
  const handleSaveStartDate = async () => {
    ...
    try {
      ...
      console.log("📤 [HR Assistant] Saving start date:", {
        applicationId,
        payload
      });
      ...
      console.log("📥 [HR Assistant] Start date save response:", response.data);
                    ...
                    <div className="card border-0 shadow-sm mb-3">
                      <div className="card-body p-3">
                          ...
                          <div style={{ minWidth: "170px" }}>
                            ...
                            >
                              {benefitsFilterOptions.departments.map((option) => (
                                <option key={`assistant-dept-${option}`} value={option}>
                          ...
                          <div style={{ minWidth: "170px" }}>
                            ...
                            >
                              {benefitsFilterOptions.positions.map((option) => (
                                <option key={`assistant-pos-${option}`} value={option}>
                        ...
                        <div className="text-muted small mt-3">
                          Filter applicants by status, department, or position to focus on the right enrollments.
                        </div>
                      </div>
                    </div>
                        ...
                        <>
                          <div className="card border-0 shadow-sm mb-3">
                            <div className="card-body d-flex flex-wrap gap-3 align-items-center justify-content-between">
                              <div>
                                <h6 className="mb-1">Enrollment Status Snapshot</h6>
                                <p className="text-muted small mb-0">
                                  Track which applicants still need benefits enrollment processing.
                                </p>
                              </div>
                              <div className="d-flex flex-wrap gap-2">
                  ...
                  (() => {
                    ...
                    <div className="card border-0 shadow-sm">
                      <div className="card-body text-center py-5">
                        ...
                        <p className="text-muted mb-0">
                          Use the Complete button inside the Benefits Enrollment modal to queue applicants here for profile setup.
                        </p>
                      </div>
                    </div>
                      );
        ...
        <Modal.Body style={PROFILE_MODAL_BODY_STYLE} className="px-4 px-lg-5 pb-5">
          <div style={PROFILE_MODAL_CONTAINER_STYLE}>
            ...
            {renderProfileSection(
              ...
              <Row className="gy-3">
                <Col md={6}>
                  <Form.Group controlId="assistantProfileFullName">
                ...
                <Col md={6}>
                  <Form.Group controlId="assistantProfileNickname">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Nickname
                    </Form.Label>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleProfileCreationInputChange("nickname", e.target.value)
                      }
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileCivilStatus">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Civil Status
                    </Form.Label>
                    <Form.Select
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileGender">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Gender
                    </Form.Label>
                    <Form.Select
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileDateOfBirth">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Date of Birth
                    </Form.Label>
                    <Form.Control
            ...
            {renderProfileSection(
              ...
              <Row className="gy-3">
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfilePhoneNumber">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Phone Number
                    </Form.Label>
                    <Form.Control
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileEmergencyContactName">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileEmergencyContactPhone">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
            ...
            {renderProfileSection(
              ...
              <Row className="gy-3">
                <Col md={3}>
                  <Form.Group controlId="assistantProfileProvince">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Province
                    </Form.Label>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleProfileCreationInputChange("province", e.target.value)
                      }
                ...
                <Col md={3}>
                  <Form.Group controlId="assistantProfileBarangay">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Barangay
                    </Form.Label>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleProfileCreationInputChange("barangay", e.target.value)
                      }
                ...
                <Col md={3}>
                  <Form.Group controlId="assistantProfileCity">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      City / Municipality
                    </Form.Label>
                    <Form.Control
                ...
                <Col md={3}>
                  <Form.Group controlId="assistantProfilePostalCode">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Postal Code
                    </Form.Label>
                    <Form.Control
                ...
                <Col xs={12}>
                  <Form.Group controlId="assistantProfilePresentAddress">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Present Address
                    </Form.Label>
                    <Form.Control
            ...
            {renderProfileSection(
              ...
              <Row className="gy-3">
                <Col md={4}>
                  <Form.Group controlId="assistantProfilePosition">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Position
                    </Form.Label>
                    <Form.Control
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileDepartment">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Department
                    </Form.Label>
                    <Form.Control
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileDateStarted">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Date Started
                    </Form.Label>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleProfileCreationInputChange("dateStarted", e.target.value)
                      }
                      style={PROFILE_INPUT_STYLE}
                      required
                    />
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileSalary">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Salary
                    </Form.Label>
                    <Form.Control
                ...
                <Col md={4}>
                  <Form.Group controlId="assistantProfileTenure">
                    <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                      Tenure
                    </Form.Label>
                    <Form.Control
            ...
            {renderProfileSection(
              ...
              <>
                ...
                <Row className="gy-3">
                  <Col md={3}>
                    <Form.Group controlId="assistantProfileSss">
                      <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                        SSS
                      </Form.Label>
                      <Form.Control
                  ...
                  <Col md={3}>
                    <Form.Group controlId="assistantProfilePhilhealth">
                      <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                        PhilHealth
                      </Form.Label>
                      <Form.Control
                  ...
                  <Col md={3}>
                    <Form.Group controlId="assistantProfilePagibig">
                      <Form.Label className={PROFILE_LABEL_CLASSNAME}>
                        Pag-IBIG
                      </Form.Label>
                      <Form.Control
