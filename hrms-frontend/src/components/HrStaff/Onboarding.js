...
const Onboarding = () => {
  ...
  const handleViewInterviewDetails = async (applicant) => {
    ...
    try {
      ...
      console.log('🔍 [Onboarding] Looking for interview details for applicant:', applicant);
      ...
      console.log('📅 [Onboarding] Stored interviews count:', storedInterviews.length);
      ...
      if (interviewDetails) {
        ...
        console.log('✅ [Onboarding] Found interview details:', interviewDetails);
        ...
        console.log('📅 [Onboarding] Stored notifications count:', storedNotifications.length);
        ...
        if (interviewNotification) {
          ...
          console.log('✅ [Onboarding] Found interview details in notifications:', interviewNotification);
          ...
          if (nameMatch) {
            ...
            console.log('✅ [Onboarding] Found interview details by name match:', nameMatch);
            ...
            console.log('❌ [Onboarding] Available stored interviews:', storedInterviews.map(i => ({
  ...
  const saveInterviewToLocalStorage = (applicant, interviewData) => {
    ...
    try {
      ...
      console.log('✅ [Onboarding] Interview details saved to localStorage:', interviewDetails);

    } catch (error) {

      console.error('❌ [Onboarding] Error saving interview to localStorage:', error);
