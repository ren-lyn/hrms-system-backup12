...
import './HrStaffProfile.css';

const HrStaffProfile = ({ onBack }) => {
  ...
  if (loading) {
    return (
      <div className="hr-staff-profile-container">
  ...
  return (
    <div className="hr-staff-profile-container dashboard-embedded">
      {onBack && (
        <button 
          onClick={onBack} 
