...
import { User, MapPin, Phone, Mail, Briefcase, ArrowLeft, Edit2 } from 'lucide-react';
import axios from 'axios';
import { Card, Row, Col, Button, Modal, Form, Alert } from 'react-bootstrap';
import './ManagerProfile.css';

const ManagerProfile = ({ onBack }) => {
  ...
  return (
    <div className="manager-profile-container dashboard-embedded">
      {onBack && (
        <button 
          onClick={onBack} 
              ...
              <Row className="mb-3">
                <Col sm={6}>
                  <div className="info-item">
                    ...
                    <p>{profile.position || profile.job_title || 'Manager'}</p>
                  </div>
                </Col>
                <Col sm={6}>
                  <div className="info-item">
